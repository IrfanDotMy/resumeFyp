...
<head>
    ...
    <title>Resume Generator By Megat Irfan</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <div class="container text-light">
    <h1 class="text-center my-5 fw-bold">Resume Form | Final Year Project </h1>
        ...
        <form action="submit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="016-274-8214" pattern="[0-9]{10}" required>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                <h2>Skills (Max:5)</h2>
            ...
            <p style="text-align: center;">Developed By Megat Irfan &copy;</p>
